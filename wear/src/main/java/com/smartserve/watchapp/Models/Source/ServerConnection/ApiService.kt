...
interface ApiService {
    ...
    suspend fun getNotifications(@Query("activity_type") activity_type:String,
                                 @Query("current_date") current_date:String): GetNotificationResponse

    @GET(PAID_BILLS)
    suspend fun getPaidBills(@Query("activity_type") activity_type:String,
                             @Query("current_date") current_date:String): GetPaidBillResponse
